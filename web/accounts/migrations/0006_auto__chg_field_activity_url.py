...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Activity.url'
        db.alter_column('accounts_activity', 'url', self.gf('django.db.models.fields.CharField')(max_length=200))


    def backwards(self, orm):
        
        # Changing field 'Activity.url'
        db.alter_column('accounts_activity', 'url', self.gf('django.db.models.fields.URLField')(max_length=200))
