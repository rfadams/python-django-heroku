...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('accounts_group', 'creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='creator_of_groups', null=True, to=orm['auth.User']), keep_default=False)

        # Removing M2M table for field invites on 'Group'
        db.delete_table('accounts_group_invites')
    ...
    def backwards(self, orm):
        ...
        # Adding M2M table for field invites on 'Group'
        db.create_table('accounts_group_invites', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('group', models.ForeignKey(orm['accounts.group'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('accounts_group_invites', ['group_id', 'user_id'])
    ...
    models = {
        ...
        'accounts.group': {
            ...
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'creator_of_groups'", 'null': 'True', 'to': "orm['auth.User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'leader': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'leader_of_groups'", 'null': 'True', 'to': "orm['auth.User']"}),
