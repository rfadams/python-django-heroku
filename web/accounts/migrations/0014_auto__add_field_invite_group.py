...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Invite.group'
        db.add_column('accounts_invite', 'group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Group'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Invite.group'
        db.delete_column('accounts_invite', 'group_id')
