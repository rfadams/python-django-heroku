...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Invite.declined'
        db.add_column('accounts_invite', 'declined', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Invite.declined'
        db.delete_column('accounts_invite', 'declined')
